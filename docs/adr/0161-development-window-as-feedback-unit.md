...
- ❌ **開いたままの窓から所見を出す。** 同じ作業が複数回数えられる
- ❌ **並行する窓を混ぜる。** 1 人の作業が複数人ぶんに見える
- ❌ **人の申告を単位にする。** 忙しい日ほど落ちる
- ❌ **記録から導いた値を、打刻された値と同じものとして出す。** 導いたことを印として残す（[0157](0157-inspection-declaration-discipline.md)）
- ❌ **窓の記録をリポジトリの追跡下へ置く。** 置き場は [0160](0160-agent-environment-loop.md) の決定 4 が持つ
