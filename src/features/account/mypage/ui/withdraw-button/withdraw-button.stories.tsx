...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      ...
      description: {
        component: [
          "退会の操作です。**確認は `AlertDialogAction` ではなく form の submit で行います** ——",
          "`AlertDialogAction` は押した時点で dialog を閉じるため、送信中の表示も失敗の文言も、利用者が",
          "見ていない場所に出ます。閉じるのは成立して画面が変わるときだけです。完了を待たずに反映される",
          "とは書きません —— 取り消しや在庫の戻しは結果整合で走るためです。",
        ].join(""),
      },
    },
  },
