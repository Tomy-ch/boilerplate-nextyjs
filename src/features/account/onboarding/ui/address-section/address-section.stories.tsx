...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          "登録の、届け先の段です。**郵便番号からの補完をここが配線します** —— 補完は住所の項目にしか",
          "関わらないので、外側が知る必要がありません。**補完が起きたことを読み上げます** —— 入力欄の値が",
          "変わるだけでは、そこを見ていない利用者に届きません。`150-0001`（町域が割れる）と",
          "`220-0012`（町域まで定まる）が引け、それ以外の番号は該当なしになります。",
        ].join(""),
      },
    },
  },
