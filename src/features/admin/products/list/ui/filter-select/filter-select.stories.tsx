...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      ...
      description: {
        component: [
          "選んだ時点で反映する絞り込みです。脇に畳まず常に見えている幅で使います。",
          "**canvas では遷移が起きません** —— 選んでも何も変わらないのはそのためです。",
          "1 つ入り切りするたびに反映するのは、結果が同じ画面にそのまま出るためで、1 つ選ぶたびに",
          "件数が変わるほうが、組み終えるまで結果が判らないより速く目的へ着きます。",
        ].join(""),
      },
    },
  },
