...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          "在庫をどちらへいくつ動かすかを決める欄です。**打っている途中の値をここが持ちます** ——",
          "送信には欄の `name` で載るので、外側のフォームはこの値を知らずに済みます。向きと量が",
          "1 つの部品なのは、見込みがその両方から決まるためです。**符号を人に書かせません** ——",
          "1 つの欄で符号付きの数を受けると、マイナスの入れ忘れがそのまま逆向きの更新になります。",
        ].join(""),
      },
    },
  },
