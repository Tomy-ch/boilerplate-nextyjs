...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          "商品の基本情報の段です。**自分が段であることを知りません** —— 表示・非表示と focus の移動は、",
          "この段を並べる器（wizard / tabs）が持ちます。知ってしまうと器を差し替えられません。",
          "価格を数値の入力欄にしないのは、サブセントまでの十進を文字列のまま運ぶためです。",
          "**誤りは触れた項目にだけ出ます** —— 開いた直後から空欄をすべて赤くしません。",
        ].join(""),
      },
    },
  },
