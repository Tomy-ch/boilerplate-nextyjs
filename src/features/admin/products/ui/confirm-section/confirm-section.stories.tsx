...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          "送る前に内容を確かめる段です。**入力欄を持ちません** —— 同じ値を 2 か所で編集できると、",
          "どちらが送られるかを読む側が推測することになります。直したい場合は前の段へ戻ります。",
          "説明は表示側と同じ経路（sanitize してから描く）で出すので、**ここで見えないものは保存しても",
          "表示されません**。中身は最初に読む一式から外してあります。",
        ].join(""),
      },
    },
  },
