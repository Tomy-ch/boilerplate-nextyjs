...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          "発送済みの注文を並べ、配達を確認します。**まとめる操作を持ちません** —— 届いたかどうかは",
          "注文ごとに分かれるので、まとめて確認できる形にすると、確かめていないものまで確認済みにする",
          "経路ができます。結果はカードに 1 つだけ出します —— 行ごとに送信状態を持たせると、同じ操作が",
          "並ぶ数だけ状態が増え、どれが最後の結果なのかが読み取れなくなります。",
        ].join(""),
      },
    },
  },
