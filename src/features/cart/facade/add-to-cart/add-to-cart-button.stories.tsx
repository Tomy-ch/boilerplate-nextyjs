...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: [
          "商品をカートへ入れる操作です。**カートの中身はバックエンドが持ちます** —— ここは入れるよう",
          "頼むだけで、入った結果は同じ往復で描き直される脇の領域と header の点数に現れます。",
          "**押した時点でカートを開きます** —— 結果を待って開くと、往復のあいだ何も起きていないように",
          "見えます。**在庫が無い商品は押せません** —— 1 つも無いと判っている商品にまで操作を残すと、",
          "押しても結果が変わらない操作が画面に残ります。",
        ].join(""),
      },
    },
  },
