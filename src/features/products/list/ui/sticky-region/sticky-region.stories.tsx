...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      ...
      description: {
        component: [
          "貼り付く領域をひとまとめにする器です。検索の帯と脇の絞り込みは、画面の別の列にありながら",
          "**上端を取り合います** —— 帯が出ているあいだ絞り込みはその下で止まり、帯が退いたら header の",
          "直下まで上がります。取り合う相手の高さは条件の数で変わるため、値を書き写さず測った値を配ります。",
          "**帯が退くのは下へ読み進めているあいだ**です（canvas を送ると確かめられます）。",
        ].join(""),
      },
    },
  },
