...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      ...
      description: {
        component: [
          "購入の状態を 1 つ進める操作です。**確認を挟みます** —— キャンセルは戻せず、支払いは金銭の意味を",
          "持ちます。確認は `AlertDialogAction` ではなく form の submit で行います（`AlertDialogAction` は",
          "押した時点で閉じるため、送信中の表示が利用者の見ていない場所に出ます）。**開く操作と確定する操作で",
          "見た目を分けます** —— 開く側は並んだ操作の中でどれを主に見せるか、確定する側は起きることの重さです。",
          "**成立したことは伝えません** —— 進んだ購入ではこの操作ごと画面から消えます。",
        ].join(""),
      },
    },
  },
