...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      ...
      description: {
        component: [
          "その購入にいまできる操作と、成立の知らせです。**成立の知らせをこの段が持ちます** —— 成立すると",
          "画面は取り直され、押した操作はその場から消えるので、知らせを抱えたまま残るのは段の側です。",
          "**通らなかったことは確認の中が伝えます** —— 送信しても確認は開いたままなので、外へ出すと利用者が",
          "見ていない場所に文言が出ます。何も送っておらず出す操作も無い購入では、余白ごと現れません。",
        ].join(""),
      },
    },
  },
