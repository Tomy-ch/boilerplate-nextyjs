...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      ...
      description: {
        component: [
          "このサイトを構成しているリポジトリの説明です。フッターの導線（`Features/SiteInfo/RepositoryLinks`）",
          "より詳しく、「何と何で出来ているのか」を読ませます。",
          "**カード全体が導線ですが link で包んではいません** —— 包むと補足を開く操作が link の内側に入るためで、支援技術にはリポジトリ名だけが遷移先として見えます。",
        ].join(""),
      },
    },
  },
